// Test project extraction from resume - realistic PDF format

const projectText = `Shopping System | Java, Spring Boot, MySQL
E-commerce platform with payment gateway integration
User authentication and authorization
Real-time inventory management

Payment Gateway | Node.js, Express, MongoDB
Secure payment processing system
API endpoint development
Database optimization

Inventory Management | Python, Flask, PostgreSQL
